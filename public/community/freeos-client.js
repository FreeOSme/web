(function () {
    ...
    function ensureHeaderStyles() {
        ...
        style.textContent =
            ...
            "#freeos-client-header .brand{display:flex;align-items:center;gap:.7rem;text-decoration:none;color:#241f31;font-weight:700;font-size:1.02rem}" +
            ...
            "#freeos-client-header .icon-release::before,#freeos-client-header .icon-changelog::before,#freeos-client-header .icon-about::before,#freeos-client-header .icon-community::before,#freeos-client-header .icon-gitlab::before,#freeos-client-header .icon-home::before,#freeos-client-header .icon-summary::before{content:'';position:absolute;inset:0;border:1.8px solid currentColor;border-radius:3px;box-sizing:border-box}" +
    ...
    function renderNavItems() {
        return NAV_ITEMS.map(function (item) {
            ...
            return "<a class=\"" + activeClass.trim() + "\" href=\"" + item.href + "\"" + external + ">" +
